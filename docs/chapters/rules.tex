...
\item[\rulebox{lualatex}{Marco Daniel, Paulo Cereda}] This rule, as the name suggests, runs the \rbox{lualatex} \TeX\ engine on the provided \mtbox{currentFile} reference, generating a corresponding file in a Portable Document File format.
...
\item[\rulebox{makeglossarieslite}{Marco Daniel, Nicola Talbot, Paulo Cereda}]
