...
\begin{itemize}
\item \mdbox{(Session.)insert(String key, Object value)}{void} to \mdbox{(Session.)put(String key, Object value)}{void}
\item \mdbox{(Session.)exists(String key)}{boolean} to \mdbox{(Session.)contains(String key)}{boolean}
\item \mdbox{(Session.)obtain(String key)}{Object} to \mdbox{(Session.)get(String key)}{Object}
\end{itemize}
\end{messagebox}
