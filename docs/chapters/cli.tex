...
% The third sentence doesn't sound quite right.
% Suggestions:
%  Hopefully you follow this custom, otherwise the visual effect won't be so pleasant.
%  Hopefully you follow the conventional use of a monospaced font in your terminal, otherwise the visual effect won't be so pleasant.
