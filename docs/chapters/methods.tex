...
% Not sure about "along the string". It doesn't sound quite right.
% Perhaps "inside the string" or "within the string"
% or (instead of superfluous) "non-boundary spaces inside the string"
...
% Wouldn't it be more normal to check the .log file for "undefined references"?
\begin{codebox}{Example}{teal}{\icnote}{white}
...
% Don't the following methods return Object rather than boolean?
