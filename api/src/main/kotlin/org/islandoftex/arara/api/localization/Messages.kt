...
public open class Messages(
    public val providedLocale: Locale = Locale.ENGLISH,
    ...
    public val ERROR_CHECKOS_INVALID_OPERATING_SYSTEM: String = "I could not check your operating system. The provided value \"%s\" does not look like a valid operating system entry in my list (I might also be wrong, of course). Please correct the value and try again.",
    ...
    public val ERROR_GETCANONICALFILE_IO_EXCEPTION: String = "I could not get the canonical file due to an IO error. I have no idea why it failed, though. Perhaps the file was moved or deleted before or during the lookup operation. Or maybe I do not have the proper permissions.",
    public val ERROR_GETPARENTCANONICALPATH_IO_EXCEPTION: String = "I could not get the parent canonical path due to an IO error. I have no idea why it failed, though. Perhaps the file was moved or deleted before or during the hashing operation. Or maybe I do not have the proper permissions.",
    ...
    public val ERROR_ISSUBDIRECTORY_NOT_A_DIRECTORY: String = "The \"isSubdirectory\" method requires a directory, not a file. It looks like \"%s\" does not appear to be a directory at all.",
    public val ERROR_LANGUAGE_INVALID_CODE: String = "The provided language code is invalid. Currently, I know how to speak the following languages: %s",
    ...
    public val LOG_INFO_POTENTIAL_DIRECTIVE_FOUND: String = "I found a potential directive: %s",
