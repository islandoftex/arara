...
class BrazilianLanguage : Messages(
        ...
        ERROR_EXTRACTOR_INTERPOLATION_FAILURE = "O parâmetro 'options' contém expressões que o interpretador MVEL não é capaz de avaliar. Por favor, verifique se 'options' não contém partes '@{…}' indevidas.",
        ...
        ERROR_INTERPRETER_COMMAND_UNSUCCESSFUL_EXIT = "O comando \"%s\" inesperadamente encerrou com um código de saída diferente de zero. Por favor, verifique a saída do comando para avaliar os próximos passos.",
        ERROR_INTERPRETER_USER_REQUESTED_HALT = "arara será interrompida neste momento conforme sua requisição (ou de uma regra).",
        ...
        ERROR_INTERPRETER_WRONG_RETURN_TYPE = "Uma regra deve retornar como tipo um valor lógico ou de comando. Outros tipos de retorno não são suportados.",
