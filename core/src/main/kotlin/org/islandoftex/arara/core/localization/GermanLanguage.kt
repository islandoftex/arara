...
class GermanLanguage : Messages(
        ...
        ERROR_EXTRACTOR_INTERPOLATION_FAILURE = "Das 'options'-Feld enthielt einen Eintrag, mit dem der MVEL-Parser nicht umgehen kann. Alle '@{…}'-Teile im options-Feld sollten noch einmal unter die Lupe genommen werden.",
        ...
        ERROR_INTERPRETER_COMMAND_UNSUCCESSFUL_EXIT = "Das Kommando \"%s\" wurde unerwarteterweise mit einem Nicht-Null-Rückgabewert beendet. Die Ausgabe des Kommandos gibt Rückschlüsse zu möglichen Lösungen des Problems.",
        ...
        ERROR_INTERPRETER_USER_REQUESTED_HALT = "Ich erhielt eine Anfrage zum Anhalten und werde dieser nachkommen.",
        ...
        ERROR_INTERPRETER_WRONG_RETURN_TYPE = "Eine Regel darf entweder einen logischen Wert (boolean value) oder ein Kommando zurückgeben. Andere Rückgabewerte werden nicht unterstützt.",
