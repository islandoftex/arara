...
class ItalianLanguage : Messages(
        ...
        ERROR_EXTRACTOR_INTERPOLATION_FAILURE = "Il campo 'options' ha un contenuto che il parser MVEL non riesce a gestire. Correggi le tue opzioni in modo che non contengano parti dannose con '@{...}'.",
