...
class ItalianLanguage : Messages(
        providedLocale = Locale.ITALIAN,
        translators = listOf("Enrico Gregorio"),
        ...
        ERROR_CHECKOS_INVALID_OPERATING_SYSTEM = "Non sono riuscito a distinguere il tuo sistema operativo. Il valore dichiarato '%s' non compare nella mia lista di sistemi operativi (potrei sbagliarmi, però). Per favore, correggi il valore e riprova.",
        ...
        ERROR_ISSUBDIRECTORY_NOT_A_DIRECTORY = "Il metodo 'isSubdirectory' richiede una directory, non un file. Sembra proprio che '%s' non sia una directory.",
        ERROR_LANGUAGE_INVALID_CODE = "La lingua richiesta non è valida. Al momento, so parlare le seguenti lingue: %s",
        ...
        LOG_INFO_POTENTIAL_DIRECTIVE_FOUND = "Ho trovato una potenziale direttiva: %s",
