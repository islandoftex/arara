...
class NorfolkLanguage : Messages(
        ...
        ERROR_EXTRACTOR_INTERPOLATION_FAILURE = "That ole 'options' field what you got have got the MVEL parser into a roight ole puckaterry. Do you tricolate yar options so you ent got narthing on the huh in yar '@{…}' parts.",
        ...
        ERROR_INTERPRETER_COMMAND_UNSUCCESSFUL_EXIT = "That ole command \"%s\" dint go roight. Do you have a peek at the output do you want ter know wass doing.",
        ...
        ERROR_INTERPRETER_USER_REQUESTED_HALT = "arara will stop do you (or yar rule) ask it to.",
        ...
        ERROR_INTERPRETER_WRONG_RETURN_TYPE = "A rule shud ony retarn a boolean or a command. Narthing else ent supported",
