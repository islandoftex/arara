...
class InputHandlingTest {
    ...
    fun shouldFlattenListsCorrectly() {
        assertEquals(InputHandling.flatten(listOf(1, 2, listOf(3, 4, listOf(5, 6))))
                .toSet(), (setOf(1, 2, 3, 4, 5, 6) as Set<Any>))
    }
}
